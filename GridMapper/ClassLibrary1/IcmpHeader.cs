...
namespace ConsoleApplication5
{
	class IcmpHeader : ProtocolHeader
	{
		...
		{
			get { return (ushort)IPAddress.NetworkToHostOrder( (short)icmpChecksum ); }
		...
		public ushort Id
		{
			get { return (ushort)IPAddress.NetworkToHostOrder( (short)icmpId ); }
		...
		{
			get { return (ushort)IPAddress.NetworkToHostOrder( (short)icmpSequence ); } 
