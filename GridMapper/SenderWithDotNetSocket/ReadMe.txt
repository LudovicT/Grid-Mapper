========================================================================
    ...
    SenderWithDotNetSocket
========================================================================

AppWizard a créé cette DLL SenderWithDotNetSocket pour vous.  

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application SenderWithDotNetSocket.

SenderWithDotNetSocket.vcxproj
...
SenderWithDotNetSocket.vcxproj.filters
